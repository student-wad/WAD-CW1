...
namespace eZone.Controllers
{
    public class GroupController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TeacherId"] = new SelectList(_context.Teachers, "Id", "Discriminator");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,GroupLevel,LessonDays,GroupTime,StartDate,NumOfStudents,CourseId,TeacherId")] Group group)
        {
            ...
            ViewData["TeacherId"] = new SelectList(_context.Teachers, "Id", "Discriminator", group.TeacherId);
            return View(group);
        }
